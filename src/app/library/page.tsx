...
export default function LibraryPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto pl-12 pr-6 sm:pl-16 sm:pr-10 py-10 sm:py-14">
      {/* Header */}
      <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6 mb-10 animate-fade-up">
        ...
        <div className="relative group">
          <svg
            className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-stone-400 group-focus-within:text-stone-600 transition-colors duration-300"
          ...
          <input
            ...
            className="pl-10 pr-4 py-2.5 rounded-lg bg-white/70 border border-stone-300 text-stone-900 placeholder:text-stone-400 focus:outline-none focus:ring-2 focus:ring-purple/20 focus:border-purple/40 transition-all duration-300 w-full sm:w-72"
          />
        </div>
      </div>
      ...
      {needsAuth ? (
        <div className="text-center py-24 animate-fade-up">
          <h2 className="text-xl font-semibold text-stone-900 mb-2">Sign in to view your library</h2>
        ...
        <div className="flex flex-col items-center justify-center py-24 gap-6 animate-fade-in">
          ...
          <p className="text-stone-500 text-sm">Loading your tracks...</p>
        </div>
      ) : songs.length === 0 ? (
        <div className="text-center py-24 animate-fade-up">
          <div className="relative w-24 h-24 mx-auto mb-8">
            <div className="absolute inset-[-20%] rounded-full bg-purple/10 blur-2xl" />
            <div className="relative w-full h-full bg-white/80 rounded-xl border border-stone-300 flex items-center justify-center shadow-sm">
          ...
          <h2 className="text-xl font-semibold text-stone-900 mb-2">No tracks yet</h2>
          <p className="text-stone-600 mb-8 max-w-sm mx-auto">
        ...
        <div className="text-center py-24 animate-fade-up">
          <p className="text-stone-600">
            No tracks match &quot;<span className="text-stone-900">{filter}</span>&quot;
          </p>
        </div>
      ) : (
        <div className="space-y-10">
          {inProgressSongs.length > 0 && (
            <div>
              <h2 className="text-xs font-medium text-stone-500 uppercase tracking-[0.2em] mb-5 flex items-center gap-2">
          ...
          {completedSongs.length > 0 && (
            <div>
              {inProgressSongs.length > 0 && (
                <h2 className="text-xs font-medium text-stone-500 uppercase tracking-[0.2em] mb-5">Completed</h2>
              )}
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
